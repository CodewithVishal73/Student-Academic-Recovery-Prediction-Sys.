...
This project applies supervised machine learning techniques to predict student academic recovery based on early-semester data such as enrolled units, evaluated units, approved units, age, and scholarship status.
